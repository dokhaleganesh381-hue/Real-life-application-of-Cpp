...
int main() {
    ...
    devices.push_back(new SmartLight("L201", "Kitchen", "OFF", "07:00"));
    devices.push_back(new Thermostat("T202", "Hall", "OFF", "07:15"));
    devices.push_back(new SecurityCamera("C203", "Back Yard", "ON", "07:30"));
    devices.push_back(new DoorLock("D204", "Garage Door", "LOCKED", "07:45"));
