...
int main() {
    ...
    fleet.push_back(make_unique<Truck>("V101", "MH12-AB-3311", 14.0));
    fleet.push_back(make_unique<DeliveryVan>("V102", "MH12-CV-7724", 65));
    fleet.push_back(make_unique<Bike>("V103", "MH12-SS-8890", false));
